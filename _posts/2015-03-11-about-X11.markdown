...
- [Xlib Programming Manaul](http://www.sbin.org/doc/Xlib/ "Xlib Programming Manaul")，Xlib编程手册。
- [Xlib Programming](http://tronche.com/gui/x/ "Xlib Programming")，这个网站也可以参考一下。
